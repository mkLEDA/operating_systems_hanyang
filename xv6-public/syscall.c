...
extern int sys_thread_join_sys(void);
extern int sys_duplicate_process(void);
...
[SYS_thread_join_sys] sys_thread_join_sys,
[SYS_duplicate_process] sys_duplicate_process,
};
